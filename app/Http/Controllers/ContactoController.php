...
class ContactoController extends Controller
{
    ...
    {
        //
        $datos['contacto']=Contacto::paginate(5);
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/contacto')->with('Mensaje','Contacto agregado con exito');
    }
    ...
    public function destroy($id)
    {
        //
        Contacto::destroy($id);
        return redirect('contacto')->with('Mensaje','Registro eliminado con exito');
    }
}
